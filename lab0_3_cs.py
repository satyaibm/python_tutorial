# Use this script in the Azure Cloud Shell.  Run the commands below in a PowerShell session then open a Python Shell to run the main body of the script.
...
$WorkFolder = "F:\Labfiles\" ; $TempFolder = "F:\Labfiles\" 
